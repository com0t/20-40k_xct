			...
			<div class="element_container">
				...
				<p>
					<?php
						...
						$item_link = sprintf( wp_kses_post( __( 'More information about HTML5 landmarks you can find <a href="%s" target="_blank">HERE</a>.', 'my-text-domain' ), array( 'a' => array( 'href' => array() ) ) ), esc_url( $url ) );
						echo $item_link;
					?>
				</p>
			...
			<div class="element_container">
				...
				<form name="oscimp_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI'] ); ?>">
					...
					<p>
						...
						<input type="text" name="wah_header_element_selector" id="header_element_selector" value="<?php echo $header_element_selector; ?>" />
					</p>
					...
					<p>
						...
						<input type="text" name="wah_sidebar_element_selector" id="sidebar_element_selector" value="<?php echo $sidebar_element_selector; ?>" />
					</p>
					...
					<p>
						...
						<input type="text" name="wah_footer_element_selector" id="footer_element_selector" value="<?php echo $footer_element_selector; ?>" />
					</p>
					...
					<p>
						...
						<input type="text" name="wah_main_element_selector" id="main_element_selector" value="<?php echo $main_element_selector; ?>" />
					</p>
					...
					<p>
						...
						<input type="text" name="wah_nav_element_selector" id="nav_element_selector" value="<?php echo $nav_element_selector; ?>" />
					</p>

					<h3><?php esc_html_e( 'Custom CSS', 'wp-accessibility-helper' ); ?></h3>

					<p>
						<textarea name="wah_custom_css" style="width:60%; height:200px;" id="wah_custom_css"><?php echo $wah_custom_css; ?></textarea>
					</p>
